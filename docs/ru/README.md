...
<img class="center zoom big-droid" src="../assets/droid42-main.png" width="80%" alt="Клевер 4.2">
...
Чат по разработке самой платформы Клевера и образа для RPi: [@devdroid](https://t.me/devdroid).

Вы можете скачать [PDF-версию](https://droid.coex.tech/droid_ru.pdf) этой документации. The English version of this documentation [is available](../en/).
