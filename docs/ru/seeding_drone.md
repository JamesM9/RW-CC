...
- [Как собрать высевающий механизм на дрон droid 4.2](#как-собрать-высевной-механизм-на-дрон-droid-42).
...
## Как собрать высевной механизм для droid 4.2
...
- Raspberry Pi 4 B из COEX droid 4.
- 2 микро-серводвигателя SG90.
- PDB (блок распределения питания) COEX droid 4.
...
Особая благодарность Международному университету Ала-Тоо за финансирование наборов droid 4.
