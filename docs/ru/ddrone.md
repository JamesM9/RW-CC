...
cd catkin_ws/src/droid/droid/www
unzip /home/pi/visual_ddrone-master.zip .
mv visual_ddrone-master ddrone
```

Теперь чтобы открыть веб-интерфейс нужно перейти по ссылке [http://192.168.11.1/droid/ddrone](http://192.168.11.1/droid/ddrone).
