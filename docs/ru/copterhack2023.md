...
Финал конкурса CopterHack 2022 прошел 27 мая 2023. Победителями стала команда 🇷🇺 **[droid Cloud Platform](../en/droid-cloud-platform.html)**.
...
|:-:|-|-|-|
|1|🇷🇺 droid Cloud Team|[droid Cloud Platform](../en/droid-cloud-platform.html)|21.7|
|2|🇧🇾 FTL|[Advanced droid 2](../en/advanced_droid_simulator_platform.html)|21|
|3|🇨🇦 droid with Motion Capture System|[droid with Motion Capture System](../en/mocap_droid.html)|20.5|
...
|✕|🇷🇺 FSOTM|[Дрон-перехватчик](https://github.com/deadln/droid/blob/interceptor/docs/ru/interceptor.md)||
|✕|🇰🇬 Бездомные|[Дрон-бездомный](https://github.com/Isa-jesus/droid/blob/trash-collector/docs/ru/show_maker.md)||
