...
Requires the [special PX4 firmware for droid](firmware.md#modified-firmware-for-droid). Before running a flip, take all necessary safety precautions.
...
map_client.update_configuration({'map': '/home/pi/catkin_ws/src/droid/aruco_pose/map/office.txt'})
```
