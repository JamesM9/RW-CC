...
<ul>
<li>Firmware for COEX Pix and Pixracer (<strong>droid 4 / droid 3</strong>) – <a id="firmware-pixracer" href=""><code>px4fmu-v4_default.px4</code></a>.</li>
...
* `px4fmu-v4_default.px4` — firmware for COEX Pix and Pixracer with EKF2 and LPE (**droid 3** / **droid 4**).
