...
We recommend using the modified version of [PX4 with COEX patches](firmware.md) for the droid drone, especially for autonomous flights. Download the latest stable version **<a class="latest-firmware v4" href="https://github.com/CopterExpress/Firmware/releases">from our GitHub</a>**.
...
4. For droid 4 select *COEX droid 4* from the dropdown menu. Otherwise select *Generic Quadrotor X*.
...
> **Info** Selecting *COEX droid 4* frame subtype doesn't require setting PID coefficients.
