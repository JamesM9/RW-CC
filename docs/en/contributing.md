...
11. Look at your new and useful article at https://droid.coex.tech !
...
You also can publish a package, that extends droid functionality, into the official [COEX Debian repository](packages.md).
