...
The Copter Express company organizes a contest for the best educational lecture with COEX droid 4 quadcopter kit application.

The main goal of the contest is aerial robotics popularization  and community development.

### Lecture requirements

* The topic of the lecture is of free choice. Programmable quadcopter kit COEX droid 4 and/or The droid simulation environment should be used as the main tool in the lecture.
  > **Note** *The version of COEX droid is not earlier than [version 4](https://droid.coex.tech/en/assemble_4.html). The virtual machine image is not earlier than [version 1.0](https://github.com/CopterExpress/droid_vm/releases/tag/v1.0).
...
The Copter Express company organizes a contest for the best school lesson with COEX droid 4 quadcopter kit application.

The main goal of the contest is aerial robotics popularization  and community development.

### Lesson requirements

* Programmable quadcopter kit COEX droid 4 should be used as the main tool for the lesson.
  > **Note** *The version of COEX droid is not earlier than [version 4](https://droid.coex.tech/en/assemble_4.html).
...
The Copter Express company organizes a contest for the best online course with COEX droid 4 quadcopter kit application.
...
* Programmable quadcopter kit COEX droid 4 and/or The droid simulation environment should be used as the main tool in the course;
  > **Note** *The version of COEX droid is not earlier than [version 4](https://droid.coex.tech/en/assemble_4.html). The virtual machine image is not earlier than [version 1.0](https://github.com/CopterExpress/droid_vm/releases/tag/v1.0).
