...
Dimensional drawing – [droid-4.2-ws.pdf](https://github.com/CopterExpress/droid/raw/master/docs/assets/dimensional-drawing/droid-4.2-ws.pdf).
...
The *droid 4* set allows you to install various flight controllers, for example *COEX Pix* and *Pixracer*.
