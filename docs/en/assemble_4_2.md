...
Dimensional drawing – [droid-4.2.pdf](https://github.com/CopterExpress/droid/raw/master/docs/assets/dimensional-drawing/droid-4.2.pdf).
...
droid 4 drone kit allows you to install various flight controllers, for example [COEX Pix](coex_pix.md) and Pixracer.
