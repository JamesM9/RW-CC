...
The team used an F450 frame based quadcopter and [droid software platform](https://github.com/CopterExpress/droid). The final source code is available [on GitHub](https://github.com/CopterExpress/robocross2019/).
