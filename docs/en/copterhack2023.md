...
The proposed projects are supposed to be open-source and be compatible with the droid quadcopter platform. Teams-participants are supposed to work on their projects throughout the competition, bringing them closer to the state of the finished product while being assisted by industry experts through lectures and regular feedback.

Final of the CopterHack 2022 was held on May 27, 2023. The winner team was the team 🇷🇺 **[droid Cloud Platform](droid-cloud-platform.md)**.
...
|:-:|-|-|-|
|1|🇷🇺 droid Cloud Team|[droid Cloud Platform](droid-cloud-platform.md)|21.7|
|2|🇧🇾 FTL|[Advanced droid 2](advanced_droid_simulator_platform.md)|21|
|3|🇨🇦 droid with Motion Capture System|[droid with Motion Capture System](mocap_droid.md)|20.5|
...
|7|🇷🇺 Lyceum №128|[Network of droid charging stations](liceu128.md)|13.7|
|✕|🇰🇬 Zavarka|[Система обмена грузами с помощью конвейера](https://github.com/aiurobotics/droid/blob/conveyance/docs/ru/conveyance.md)||
|✕|🇷🇺 FSOTM|[Drone Interceptor](https://github.com/deadln/droid/blob/interceptor/docs/ru/interceptor.md)||
|✕|🇰🇬 Homelesses|[Trash Collector](https://github.com/Isa-jesus/droid/blob/trash-collector/docs/ru/show_maker.md)||
|✕|🇷🇺 Digital otters|[Digital otters](https://github.com/Mentalsupernova/droid_cool/blob/new-article.md/docs/ru/new-article.md)||
|✕|🇷🇺 Light Flight|[Сопровождение БПЛА при посадке](https://github.com/SirSerow/droid_inertial_ns/blob/inertial-1/Description.md)||
|✕|🇰🇬 LiveSavers|[LiveSavers](https://github.com/Sarvar00/droid/blob/livesavers/docs/ru/livesaver.md)||
|✕|🇷🇺 XenCOM|[Bound by fate](https://github.com/xenkek/droid/blob/xenkek-patch-1/docs/ru/bound_by_fate.md)||
|✕|🇷🇺 Ava_droid|[Doubledroid](https://github.com/bessiaka/droid/blob/Ava_droid/docs/ru/soosocta.md)||
|✕|🇷🇺 TPU_1|[Совместная транспортировка груза](https://github.com/shamoleg/droid/blob/tpu_1/docs/ru/tpu_1.md)||
|✕|🇷🇺 TPU_2|[Алгоритм полета сквозь лесную местность](https://github.com/shamoleg/droid/blob/tpu_2/docs/ru/tpu_2.md)|&nbsp;|
...
Teams-participants are supposed to be added to the special Telegram group, where one can send the project's updates and get feedback from the Jury. For all participating teams, COEX will provide a 40% discount on the droid drone kit.
