...
> **Note** In the image version **0.20** `clever` package and service was renamed to `droid`. See [previous version of the article](https://github.com/CopterExpress/droid/blob/v0.19/docs/en/autolaunch.md) for older images.
