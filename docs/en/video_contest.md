...
- the video contains the entire process of assembling and configuring the droid 4.2 drone kit: from opening the box with components to flying the copter in Position mode using ArUco markers;
