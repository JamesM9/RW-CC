# Information: https://droid.coex.tech/en/simple_offboard.html#navigateglobal
...
# https://droid.coex.tech/en/snippets.html#wait_arrival
...
if math.isnan(start.lat):
    raise Exception('No global position, install and configure GPS sensor: https://droid.coex.tech/gps')
