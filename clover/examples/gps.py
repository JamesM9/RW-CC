# Information: https://droid.droid.tech/en/simple_offboard.html#navigateglobal
...
# https://droid.droid.tech/en/snippets.html#wait_arrival
...
if math.isnan(start.lat):
    raise Exception('No global position, install and configure GPS sensor: https://droid.droid.tech/gps')
