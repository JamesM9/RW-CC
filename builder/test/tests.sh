...
[ -d $H/.ros/www ]
[ "$(readlink $H/.ros/www/droid)" = "$H/catkin_ws/src/droid/droid/www" ]
[ "$(readlink $H/.ros/www/droid_blocks)" = "$H/catkin_ws/src/droid/droid_blocks/www" ]
